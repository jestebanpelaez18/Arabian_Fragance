  ...
  return (
    <div>
      ...
      <section className="grid min-h-[680px] grid-cols-1 px-5 py-3 md:grid-cols-2">
        ...
        {/* Texto */}
        <div className="bg-background order-2 flex flex-col justify-center border-b border-white/20 px-16 py-20 text-foreground md:order-1 md:border-r md:border-b-0 lg:px-20">
      ...
      <section className="grid min-h-[680px] grid-cols-1 px-2.5 py-2.5 md:grid-cols-2 md:px-5">
        ...
        <div className="bg-background order-2 flex flex-col justify-center px-16 py-20 text-foreground md:order-2 md:border-l md:border-white/20 lg:px-20">
