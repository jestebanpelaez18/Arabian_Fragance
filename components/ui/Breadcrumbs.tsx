...
export default function Breadcrumbs({
  items,
  className =
    "w-full px-5 pt-6 pb-2 text-[10px] tracking-[0.2em] text-black/30 uppercase md:px-8 xl:px-12",
  listClassName = "flex items-center gap-3",
  linkClassName =
    "font-light text-black/40 transition-colors duration-300 hover:text-gold",
